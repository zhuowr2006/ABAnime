...
public class LiveGSYVideoPlayer extends GSYVideoPlayer {
    ...
    protected LiveGSYVideoPlayer.DismissControlViewTimerTask mDismissControlViewTimerTask;
    ...
    private void startDismissControlViewTimer() {
        ...
        mDismissControlViewTimerTask = new LiveGSYVideoPlayer.DismissControlViewTimerTask();
