...
public class DanmakuVideoPlayer extends LiveGSYVideoPlayer {
    ...
    protected void init(Context context) {
        ...
        prgLayout= (LinearLayout) findViewById(R.id.prg_layout);
        danmuLayout= (LinearLayout) findViewById(R.id.danmu_layout);
    ...
    public void setisLive(){
        prgLayout.setVisibility(GONE);
        danmuLayout.setVisibility(GONE);
        isLive=true;
    }
    public void setGonBottomLayout(){
